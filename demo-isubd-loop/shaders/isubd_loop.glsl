...
void subd(in uint key, in vec4 v_in[12], out vec4 v_out[3])
{
    mat4 xfu, xfv; keyToXform(key, xfu, xfv);
    mat3x4 x_in = mat3x4(v_in[0].x, v_in[4].x, v_in[ 8].x,
                         v_in[1].x, v_in[5].x, v_in[ 9].x,
                         v_in[2].x, v_in[6].x, v_in[10].x,
                         v_in[3].x, v_in[7].x, v_in[11].x);
    mat3x4 y_in = mat3x4(v_in[0].y, v_in[4].y, v_in[ 8].y,
                         v_in[1].y, v_in[5].y, v_in[ 9].y,
                         v_in[2].y, v_in[6].y, v_in[10].y,
                         v_in[3].y, v_in[7].y, v_in[11].y);
    mat3x4 z_in = mat3x4(v_in[0].z, v_in[4].z, v_in[ 8].z,
                         v_in[1].z, v_in[5].z, v_in[ 9].z,
                         v_in[2].z, v_in[6].z, v_in[10].z,
                         v_in[3].z, v_in[7].z, v_in[11].z);
    mat3x4 x_out = xfu * x_in;
    mat3x4 y_out = xfu * y_in;
    mat3x4 z_out = xfu * z_in;
