...
struct CameraManager {
	...
	45.f, 0.01f, 1024.f,
	dja::vec3(2.5f),
	dja::mat3::lookat(dja::vec3(1), dja::vec3(0,0,0.1f), dja::vec3(0,0,1))
};
...
bool loadColormapTexture()
{
	...
	if (g_sphere.shading.pathToCmap) {
		...
		djgt_push_image(djgt, g_sphere.shading.pathToCmap, false);
